package com.example.administrator.phonehelper.dao;
...
public class DataBaseOpenHelper {
     ...
     */
    public static DataBaseOpenHelper getManager(){
        return mInstance;
    }
    ...
    public SQLiteDatabase getDatabase(String dbfile) {
        ...
        SharedPreferences dbs = context.getSharedPreferences(DataBaseOpenHelper.class.toString(), 0);
